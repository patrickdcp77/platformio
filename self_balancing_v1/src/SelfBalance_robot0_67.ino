...
/*
http://www.instructables.com/id/Chappie-Self-Balancing-Robot/?ALLSTEPS
cablage https://github.com/ManpreetSingh80/CHAPPIE/blob/master/circuit%20diagrams/Self_balance.pdf
...
int STBY = 7; //standby  le standby sur le module driver des moteurs**************************
...
void setup()
{
  ...
  pinMode(STBY, OUTPUT);//le standby sur le module driver des moteurs****************
