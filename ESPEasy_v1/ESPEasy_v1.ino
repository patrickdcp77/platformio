...
/*
pour programmer, faire un reset du module
mettre pin 0 au GND tout en mettant une résistance pullup de 1K entre 3,3V et la pin 0 
le téléversement se fait alors
déconnecter le GND de la pin 0 mais laisser la pin 0 au 3,3v via la 1K

*/

#define DEFAULT_NAME        "newdevice"         // Enter your device friendly name
#define DEFAULT_SSID        "maison"              // Enter your network SSID*************votre point d'accès
#define DEFAULT_KEY         "b5c84f1cec"            // Enter your network WPA key*****************votre mot de passe
#define DEFAULT_SERVER      "192.168.0.25"       // Enter your Domoticz Server IP address****************adresse du système qui a Domoticz installé, ici mon raspberry
#define DEFAULT_PORT        8080                // Enter your Domoticz Server port value***********le port lié au Domoticz du raspberry
