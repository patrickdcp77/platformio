...
#define DEFAULT_NAME        "nodemcuv2"         // Enter your device friendly name
#define DEFAULT_SSID        "MLC"//"maison"              // Enter your network SSID
#define DEFAULT_KEY         "ea1a5ead7cd63"//"b5c84f1cec"            // Enter your network WPA key
#define DEFAULT_SERVER      "192.168.0.25"       // Enter your Domoticz Server IP address
