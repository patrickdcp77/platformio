...
LiquidCrystal lcd(8,9,4,5,6,7); // Code changes to work with NANO by KC2UEZ
...
int audioOutPin = 10;  // Changed to work with Nano by KC2UEZ
int ledPin = 13;
...
int n=48.0;  //// if you change  her please change next line also 
int testData[48];
float bw;
